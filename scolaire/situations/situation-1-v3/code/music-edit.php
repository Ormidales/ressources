...
<body style="font-family: Source Code Pro;" class="p-8 bg-[#151515]">
	...
	<form method="post">
		...
		<input type="text" name="music_titre" placeholder="Titre de la musique" value="<?= $musicTitre ?>" class="border border-gray-300 w-[50vh] h-[8vh] p-3 rounded-lg"><br>

		<input type="text" name="music_playlist" placeholder="Playlist de la musique" value="<?= $musicPlaylist ?>" class="border border-gray-300 w-[50vh] h-[8vh] p-3 mt-3 rounded-lg"><br>

		<textarea name="music_link" placeholder="Lien vers la musique" class="border border-gray-300 w-[50vh] h-[15vh] mt-3 p-3 rounded-lg"><?= $musicLink ?>"</textarea><br>

		<input type="submit" value="Modifier la musique" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 transition-all text-white mt-3 rounded-lg">
