...
<html>
	<head>
		<title>Cours de passage | Cours "<?= $nomCours ?>"</title>
		<meta charset="utf-8">
			...
			<div class="w-full h-[6vh] bg-[#252525] border-b border-zinc-700 flex items-center">
				...
				<div class="w-[85%] h-[6vh] flex justify-between">
					...
					<div class="ml-5 flex items-center">
						...
						<p class="text-white text-[16px]">Classe de Javascript | Administrateur (@hugodoueil)</p>
					...
					<div class="w-full flex items-center">
						...
						<div class="w-[25%] h-[94vh] flex items-center justify-center flex-wrap p-4 overflow-y-scroll border-r border-zinc-700">
							...
							<a href="cours.php?id=<?= $a['id'] ?>"><div class="w-[30vh] px-6 py-4 bg-[#202020] border border-zinc-700 group hover:border-zinc-300 transition-all m-6">
								...
								<div class="w-full pt-3 border-t border-zinc-700 mt-3">
									
									<a href="edit-cours.php?id=<?= $a['id'] ?>" class="group"><p class="text-gray-300 text-[12px] group-hover:text-white transition-all">Modifier le cours</p></a>

									<a href="delete-cours.php?id=<?= $a['id'] ?>" class="group"><p class="mt-1 text-gray-300 text-[12px] group-hover:text-white transition-all">Supprimer le cours</p></a>
						...
						<div class="w-[75%] h-[94vh] px-8 py-10 overflow-y-scroll animate__animated animate__fadeInRight">

							<div id="menuInformationCours" class="hidden">

								<svg xmlns="http://www.w3.org/2000/svg" onclick="closeMenuInformationCours()" class="w-6 h-6 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
								  	<path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
								</svg>
								
								<div class="mt-3 w-[22vh] h-[2.5vh] flex items-center justify-center bg-<?= $couleurCours ?>">Informations sur le cours</div>

								<p class="mt-2"><?= $auteurCours ?> a déposé le cours "<?= $nomCours ?>" le <?= $dateCours ?>.</p>

								<p class="mt-2">Auteur : <?= $auteurCours ?></p>

								<p class="mt-2">Date de mise en ligne du cours : <?= $dateCours ?></p>

								<p class="mt-2">Classe : <?= $classeCours ?></p>

								<p class="mt-2">Nom du cours : <?= $nomCours ?></p>

								<p class="mt-2">Couleur du cours : <?= $couleurCours ?></p>
							...
							<div class="w-full mt-8">
								...
								<p class="text-white text-[14px] break-words"><?= $contenuCours ?></p>
