<nav class="bg-gray-800 px-2 sm:px-4 py-2.5 border-b border-gray-700">
  ...
  <div class="flex items-center md:order-2">
      ...
      <div class="hidden z-50 my-4 text-base list-none border border-gray-700 bg-gray-800 rounded divide-y divide-gray-700 shadow" id="dropdown">
        ...
        <ul class="py-1" aria-labelledby="dropdown">
          ...
          <li>
            <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Proposer une nouvelle musique</a>
          </li>
        </ul>
      </div>
  ...
  <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
      ...
      <li>
        <a href="liste-music.php" class="block py-2 pr-4 pl-3 text-gray-700 rounded border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Playlists</a>
      </li>
      <li>
        <a href="liste-music2.php" class="block py-2 pr-4 pl-3 text-gray-700 rounded border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Musiques</a>
      </li>
      <li>
