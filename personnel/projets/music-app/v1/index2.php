			  ...
			  <div class="max-w-screen-xl px-4 py-20 mx-auto lg:items-center lg:flex">
			    <div class="max-w-3xl mx-auto text-center">
			      ...
			      <div class="flex flex-wrap justify-center gap-4 mt-8">
			        ...
			        <a class="block w-full px-12 py-3 text-sm font-medium text-white border border-blue-600 rounded sm:w-auto hover:bg-blue-600 active:bg-blue-500 focus:outline-none focus:ring transition-all" href="/about">
			          Documentation
			        </a>
			      </div>
			    </div>
