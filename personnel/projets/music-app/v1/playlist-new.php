...
<body style="font-family: Source Code Pro;" class="p-8 bg-[#202020]">
	...
	<form method="post">
		...
		<input type="text" name="playlist_nom" placeholder="Titre de la playlist" class="border border-gray-300 w-[50vh] h-[8vh] p-3"><br>

		<input type="text" name="playlist_libelle" placeholder="Libelle de la playlist" class="border border-gray-300 w-[50vh] h-[8vh] p-3 mt-3"><br>

		<input type="text" name="playlist_imageFond" placeholder="Image de fond de la playlist" class="border border-gray-300 w-[50vh] h-[8vh] p-3 mt-3"><br>

		<textarea name="playlist_commentaire" placeholder="Commentaire de la playlist" class="border border-gray-300 w-[50vh] h-[15vh] mt-3 p-3"></textarea><br>

		<input type="submit" value="Ajouter la playlist" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 transition-all text-white mt-3">
