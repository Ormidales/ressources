	...
	<body style="font-family: Poppins, sans-serif;" class="bg-[#151515]">
		...
		<div class="w-full h-[100vh] md:overflow-hidden overflow-auto md:flex md:items-center block">
			...
			<div class="md:w-[5%] md:h-[100vh] w-full md:p-0 p-5 bg-[#151515] border-r border-[#454545] flex md:flex-col items-center md:justify-start justify-evenly animate__animated animate__fadeInLeft">
				...
				<a href="index.php"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md md:mt-5 mt-0 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10" data-tooltip="Ouvrir l'application Menu" title="Page d'accueil">
				...
				<a href="task"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md md:mt-5 mt-0 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
			...
			<div id="bureau" class="md:w-[95%] w-full h-[100vh] bg-[url('ressources/UnicornVectorGradient_13.jpg')] bg-cover bg-center animate__animated animate__fadeInDown flex items-center justify-center">
				
				<div class="px-6 py-4 bg-[#151515] border border-[#454545] rounded-md">

					<p class="text-white text-[24px] mb-3">hugodoueil-station</p>

					<p class="text-white text-[16px] mb-3">Liens vers les différentes parties du site :</p>

					<div class="flex items-center">
						
						<a href="index.php"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md mr-5 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
						...
						<a href="portfolio"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md mr-5 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
						...
						<a href="task"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md mr-5 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
						...
						<a href="music"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md mr-5 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
						...
						<a href="search"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md mr-5 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
						...
						<a href="ressources"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md mr-5 bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
						...
						<a href="colors"><div class="w-[5vh] h-[5vh] border border-[#454545] rounded-md bg-white/5 flex items-center justify-center text-white hover:scale-95 hover:bg-white/10 transition-all shadow shadow-white/10">
