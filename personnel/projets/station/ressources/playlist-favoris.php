...
$ressources = $bdd->prepare('SELECT * FROM ressources_ressources WHERE favoris LIKE "%oui%" ORDER BY nom');
...
<html>
	...
	<body style="font-family: Poppins, sans-serif;">
		...
		<div class="w-full h-[100vh] md:overflow-hidden overflow-auto md:flex md:items-center block">
			...
			<div class="md:w-[79%] w-full h-[100vh] bg-[url('UnicornVectorGradient_13.jpg')] bg-cover bg-center">
				
				<div class="w-full h-[5vh] border-b border-[#454545] bg-[#151515] flex items-center justify-between px-5">
					
					<p class="text-white text-[12px]">Ressources favorites</p>
				...
				<div class="w-full h-[95vh] overflow-y-scroll p-10 grid md:grid-cols-3 grid-cols-1 gap-5">
					...
					<div class="md:w-full h-[25vh] p-5 rounded-md border border-[#454545] bg-[#151515] hover:bg-[#151515]/[85%] hover:backdrop-blur-xl transition-all group overflow-hidden shadow shadow-stone-900/75 ring-0 hover:ring-4 ring-[#454545]/75 ring-offset-0">
						...
						<div class="w-full flex items-center group-hover:mb-4">
						...
						<div class="w-full">
							...
							<span class="px-2 py-1 rounded-sm bg-green-300/10 text-green-300 text-[11px]">Ressource favorite</span>
