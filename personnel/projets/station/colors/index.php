...
if(isset($_GET['supprimer-palette']) AND !empty($_GET['supprimer-palette'])){
	$supprimer_palette = (int) $_GET['supprimer-palette'];
	$req = $bdd->prepare('DELETE FROM colors_palettes WHERE id = ?');
	$req->execute(array($supprimer_palette));
...
<html>
	...
	<body style="font-family: Poppins, sans-serif;" class="bg-[#151515]">
		...
		<div class="w-full h-[100vh] md:overflow-hidden overflow-auto md:flex md:items-center block">
			...
			<div class="md:w-[79%] w-full h-[100vh] bg-[#151515] animate__animated animate__fadeInDown flex items-center justify-center">
				
				<div class="px-6 py-4">

					<a href="palette-new.php" class="group block max-w-xs mx-auto rounded-lg p-6 bg-[#151515] border border-[#454545] ring-0 active:ring-2 ring-[#454545]/50 shadow-lg space-y-3 hover:bg-[#454545]/25">
					  <div class="flex items-center space-x-3">
					    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 text-white" viewBox="0 0 16 16">
						  	<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"/>
						</svg>
					    <h3 class="text-white text-sm">Créer une nouvelle palette</h3>
					  </div>
					</a>

					<a href="color-new.php" class="mt-5 group block max-w-xs mx-auto rounded-lg p-6 bg-[#151515] border border-[#454545] ring-0 active:ring-2 ring-[#454545]/50 shadow-lg space-y-3 hover:bg-[#454545]/25">
					  <div class="flex items-center space-x-3">
					    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 text-white" viewBox="0 0 16 16">
						  	<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"/>
						</svg>
					    <h3 class="text-white text-sm">Créer une nouvelle couleur</h3>
					  </div>
					</a>
