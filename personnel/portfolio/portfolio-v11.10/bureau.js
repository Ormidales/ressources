...
function boutonAppWelcomeZoomIn(){
    document.getElementById("application-welcome").style.width = "150vh";
    document.getElementById("application-welcome").style.height = "85vh";
    document.getElementById("application-welcome-body").style.height = "74vh";
...
function boutonAppCVZoomIn(){
    document.getElementById("application-CV").style.width = "150vh";
    document.getElementById("application-CV").style.height = "85vh";
    document.getElementById("application-CV-body").style.height = "74vh";
...
function boutonAppMentionsLegalesZoomIn(){
    document.getElementById("application-mentionslegales").style.width = "150vh";
    document.getElementById("application-mentionslegales").style.height = "85vh";
    document.getElementById("application-mentionslegales-body").style.height = "74vh";
...
function boutonAppParametreConfidentialiteZoomIn(){
    document.getElementById("application-parametreconfidentialite").style.width = "150vh";
    document.getElementById("application-parametreconfidentialite").style.height = "85vh";
    document.getElementById("application-parametreconfidentialite-body").style.height = "74vh";
...
function boutonAppPlanSiteZoomIn(){
    document.getElementById("application-plandusite").style.width = "150vh";
    document.getElementById("application-plandusite").style.height = "85vh";
    document.getElementById("application-plandusite-body").style.height = "74vh";
...
function boutonAppTRUDUCUClickedIn(){
    document.getElementById("application-welcome").style.top = "15%";
    document.getElementById("application-welcome").style.left = "20%";

    document.getElementById("application-catalogue").style.top = "15%";
    document.getElementById("application-catalogue").style.left = "20%";

    document.getElementById("application-CV").style.top = "15%";
    document.getElementById("application-CV").style.left = "20%";

    document.getElementById("application-parametre").style.top = "15%";
    document.getElementById("application-parametre").style.left = "20%";

    document.getElementById("application-changementtheme").style.top = "15%";
    document.getElementById("application-changementtheme").style.left = "20%";

    document.getElementById("application-projets").style.top = "15%";
    document.getElementById("application-projets").style.left = "20%";

    document.getElementById("application-stages").style.top = "15%";
    document.getElementById("application-stages").style.left = "20%";

    document.getElementById("application-mentionslegales").style.top = "15%";
    document.getElementById("application-mentionslegales").style.left = "20%";

    document.getElementById("application-parametreconfidentialite").style.top = "15%";
    document.getElementById("application-parametreconfidentialite").style.left = "20%";

    document.getElementById("application-plandusite").style.top = "15%";
    document.getElementById("application-plandusite").style.left = "20%";
}
