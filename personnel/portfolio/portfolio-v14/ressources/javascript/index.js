...
function background_gradient4(){
    document.getElementById("bureau-xl").className = "w-full h-[100vh] bg-gradient-to-r from-[#43e97b] to-[#38f9d7] bg-cover bg-center flex items-center justify-center flex-wrap overflow-hidden";
    document.getElementById("bureau-xl").style.transition = "background 200ms";
}

// CHANGEMENT BACKGROUND (GRADIENT 5)
function background_gradient5(){
    document.getElementById("bureau-xl").className = "w-full h-[100vh] bg-gradient-to-r from-[#fa709a] to-[#fee140] bg-cover bg-center flex items-center justify-center flex-wrap overflow-hidden";
    document.getElementById("bureau-xl").style.transition = "background 200ms";
}
...
// CHANGEMENT BACKGROUND (IMAGE 8)
function background_image8(){
    document.getElementById("bureau-xl").className = "w-full h-[100vh] bg-[url('ressources/images/background-8.jpg')] bg-cover bg-center flex items-center justify-center flex-wrap overflow-hidden";
    document.getElementById("bureau-xl").style.transition = "background 200ms";
}
