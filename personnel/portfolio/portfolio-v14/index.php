...
<html>
	...
	<body style="font-family: Poppins, sans-serif;" class="sm:overflow-hidden">
		...
		<section id="bureau-xl" class="sm:flex hidden w-full h-[100vh] bg-[url('ressources/images/background-7.jpg')] bg-cover bg-center items-center justify-center flex-wrap overflow-hidden">
			...
			<div class="absolute top-6 left-6 p-4 bg-stone-900/25 backdrop-blur-md rounded-md border border-white/10 shadow shadow-stone-900/10 grid grid-cols-3 gap-4 z-[1]">
			...
			<!-- APPLICATION MENU -->
			<div id="app-menu" class="absolute bottom-6 left-6 w-[40vh] p-2 ml-5 bg-stone-900 rounded-lg border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-background" class="absolute top-6 left-6 w-[35vh] p-2 ml-5 bg-stone-900 rounded-lg border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div class="w-full h-[40vh] overflow-y-scroll pr-2 mt-2">
					...
					<div class="w-full">
						...
						<div class="w-full p-3">
							...
							<div class="mt-3 w-full rounded-lg h-[10vh] bg-[url('ressources/images/background-8.jpg')] bg-cover bg-center border border-stone-700 hover:border-white transition-all flex items-center justify-center cursor-pointer" onclick="background_image8()">
								
								<span class="px-3 py-2 bg-white/10 rounded-lg backdrop-blur-xl border border-white/25 text-white text-[10px]">Image n°8</span>
			...
			<div id="app-welcome" class="absolute top-6 left-6 w-[40vh] p-3 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div class="w-full mt-5 md:flex md:items-center gap-x-3 block">
					...
					<a onclick="ouvrir_app_projets()" class="md:w-1/2 w-full px-3 py-2 bg-gray-500 hover:bg-gray-400 transition-all text-[10px] text-white flex items-center justify-center rounded-md cursor-pointer">Mes projets</a>
			...
			<div id="app-magasin" class="absolute top-6 left-6 w-[60vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-veilletechno" class="absolute top-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<!-- APPLICATION IMAGES -->
			<div id="app-images" class="absolute top-6 left-6 w-[25vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-plandusite" class="absolute top-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
		...
		<div id="bureau-sm" class="sm:hidden block w-full">
                
            <!-- BACKGROUND -->
            <section class="relative w-full bg-[url('ressources/images/background-5.webp')] bg-cover bg-fixed flex justify-center p-8">
                                
                <div class="relative w-[100vh] p-8 bg-white/25 backdrop-blur-lg rounded-2xl shadow-xl">
                    
                    <img src="img/png/KEEPSMILING.webp" style="animation: 3s infinite alternate image-boing;" class="relative w-56 h-56" alt="KEEPSMILING.webp" title="Logo">

                    <h1 class="mt-10 text-[100px] text-white font-bold">HUGO</h1>
                    <h1 class="mt-10 text-[100px] text-white font-bold">DOUEIL</h1>

                    <p class="mt-10 text-[20px] text-white font-bold" style="letter-spacing: 1vh;">Étudiant BTS SIO SLAM Auch (32000)</p>

                    <div class="mt-20 w-full h-0 border-t border-slate-100"></div>

                    <p class="mt-20 text-[35px] text-white font-bold" style="letter-spacing: 1vh;">QUI SUIS-JE ?</p>

                    <p class="mt-10 text-[20px] text-white" style="letter-spacing: 0.5vh;">Bonjour, je m'appelle Hugo Doueil, je suis un étudiant de BTS SIO SLAM au lycée Pardailhan à Auch (32000). Intéressé par l'informatique et la conception de site web, J'aimerai me spécialiser dans ce domaine et en faire mon métier. Pour cela, j'ai pris connaissance de plusieurs langages informatiques tels que les langages de Balisages (HTML, CSS), de Programmations (C#, Javascript, PHP, etc...), je pratique le développement chez moi car j'aime créer mes propres sites webs.</p>

                    <div class="mt-10 w-full flex items-center flex-wrap">
                        
                        <div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25 flex items-center" style="letter-spacing: 0.5vh;">
                        ...
                        <div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25 flex items-center" style="letter-spacing: 0.5vh;">
                    ...
                    <div class="mt-10 w-full flex items-center flex-wrap">
                        ...
                        <div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
                        ...
                        <a href="html/stages.html"><div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
                    ...
                    <div class="mt-10 w-full bg-[url('img/background/bg-2.webp')] bg-cover bg-fixed rounded-tl-2xl rounded-br-2xl border border-white shadow-xl" data-tilt data-tilt-scale="0.95" data-tilt-perspective="1000" data-tilt data-tilt-max="5" style="transform-style: preserve-3d; transform: perspective(1000px);">

                        <div class="w-full p-8 rounded-tl-2xl rounded-br-2xl backdrop-blur-lg">
                            
                            <div class="w-full h-96 bg-[url('img/background/portfolio.webp')] bg-cover rounded-tl-2xl rounded-br-2xl border border-white" style="transform: translateZ(20px);"></div>
                            ...
                            <div class="mt-8 flex items-center">
                                ...
                                <div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh; transform: translateZ(20px);">
                    ...
                    <div class="mt-10 w-full bg-[url('img/background/bg-2.webp')] bg-cover bg-fixed rounded-tl-2xl rounded-br-2xl border border-white shadow-xl" data-tilt data-tilt-scale="0.95" data-tilt-perspective="1000" data-tilt data-tilt-max="5" style="transform-style: preserve-3d; transform: perspective(1000px);">
                        ...
                        <div class="w-full p-8 rounded-tl-2xl rounded-br-2xl backdrop-blur-lg">
                            ...
                            <div class="w-full h-96 bg-[url('img/background/ppe1.webp')] bg-cover rounded-tl-2xl rounded-br-2xl border border-white" style="transform: translateZ(20px);"></div>
                    ...
                    <div class="mt-10 w-full bg-[url('img/background/bg-2.webp')] bg-cover bg-fixed rounded-tl-2xl rounded-br-2xl border border-white shadow-xl" data-tilt data-tilt-scale="0.95" data-tilt-perspective="1000" data-tilt data-tilt-max="5" style="transform-style: preserve-3d; transform: perspective(1000px);">
                        ...
                        <div class="w-full p-8 rounded-tl-2xl rounded-br-2xl backdrop-blur-lg">
                            ...
                            <div class="w-full h-96 bg-[url('img/background/ppe2.webp')] bg-cover rounded-tl-2xl rounded-br-2xl border border-white" style="transform: translateZ(20px);"></div>
                    ...
                    <div class="mt-10 w-full flex items-center flex-wrap">
                        ...
                        <div class="py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
                        ...
                        <div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
                    ...
                    <div class="mt-10 w-full flex items-center flex-wrap">
                        ...
                        <div class="py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
                        ...
                        <div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[15px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
