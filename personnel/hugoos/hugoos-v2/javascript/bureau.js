...
/*function BodyLoading(){
    document.getElementById("bureau").style.animationName = "BodyLoadingBureau";
    document.getElementById("bureau").style.animationDuration = "2s";
}*/
...
function boutonChangementThemeCyberpunk(){
    document.getElementById("bureau").style.backgroundImage = "url('img/Background/cyberpunk.webp')";
    document.getElementById("bureau").style.backgroundPosition = "center";
}
function boutonChangementThemeSpace(){
    document.getElementById("bureau").style.backgroundImage = "url('img/Background/space.webp')";
    document.getElementById("bureau").style.backgroundPosition = "center";
}
