	...
	<body style="font-family: Poppins, sans-serif;" class="md:overflow-hidden">
		...
		<div class="loader z-[99999] bg-gray-300">
			<div class="block">
				...
				<div class="w-[45vh] p-3 bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 rounded-lg shadow shadow-stone-900 animate__animated animate__fadeInRight">
	    ...
	    <!-- BUREAU -->
		<section id="bureau-xl" class="md:flex hidden w-full h-[100vh] bg-[url('ressources/images/bg-1.jpg')] bg-cover bg-center items-center justify-center flex-wrap overflow-hidden">
			...
			<div id="fenetreBienvenue" class="w-full absolute z-[9999] top-0 left-0 h-[100vh] bg-white/10 backdrop-blur-xl flex items-center justify-center">
				...
				<div class="w-[45vh] p-4 rounded-2xl bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 shadow shadow-stone-900/75 animate__animated animate__fadeInRight">
			...
			<div id="contextMenu" class="context-menu z-[9999999] p-1">
				<div class="flex items-center">
					...
					<div id="contextMenu_sub1" class="w-[25vh] h-[40.9vh] rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 shadow shadow-stone-900/75 overflow-y-auto">
						...
						<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer" onmouseover="ouvrir_contextMenu_sub2_projets()" onmouseout="fermer_contextMenu_sub2_projets()">
					...
					<div id="contextMenu_sub2">
						...
						<div id="contextMenu_sub2_projets" class="hidden w-[30vh] h-[40.9vh] rounded-r-lg bg-stone-900/[85%] backdrop-blur-xl border-t border-r border-b border-stone-700 shadow shadow-stone-900/75 overflow-y-scroll" onmouseover="ouvrir_contextMenu_sub2_projets()" onmouseout="fermer_contextMenu_sub2_projets()">
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Scolaire - Situations BTS</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - Boursatron</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - HugoOS</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - hugodoueil-station</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - hugodoueil-station/ressources</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - hugodoueil-station/colors</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - hugodoueil-station/search</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - hugodoueil-station/portfolio</p>
							...
							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer">
								...
								<p class="text-[12px] ml-2">Projet Personnel - hugodoueil-station/task</p>

							</div>

							<div class="px-3 py-2 flex items-center text-white hover:bg-white/10 transition-all cursor-pointer mb-1">
								
								<svg xmlns="http://www.w3.org/2000/svg" class="h-[16px] w-[16px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
								  	<path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
								</svg>

								<p class="text-[12px] ml-2">Projet Personnel - hugodoueil-station/music</p>
            ...
            <div id="app-retrocomp" class="absolute top-0 left-0 w-full p-5 bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[9998] rounded-b-md">
            	...
            	<div class="w-full flex items-center justify-between">
            		...
            		<div class="flex items-center">
						...
						<span class="ml-3 text-blue-500 bg-blue-500/10 rounded-md px-2 py-1 text-[11px] border border-blue-500/25">Version AlphaBuild.SDK.HugoOS-v5</span>
            	...
            	<div class="w-full flex items-center pb-3" style="overflow-x:scroll; overflow-y:hidden; white-space: nowrap;">
            		...
            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">HugoOS-v1</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">HugoOS-v2</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">HugoOS-v3</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">HugoOS-v4</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">HugoOS-v5</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Maquette</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v0</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v1</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v1.5</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v2</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v3</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v4</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v5</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v6</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v7</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v7.1</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v7.2</span>
            		...
            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v10 (stackblitz edition)</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.1</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.2</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.3</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.4</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.5</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.6</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.7</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.8</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.9</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v11.10</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v12</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] mr-3 transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v13</span>

            		<span class="px-4 py-2 rounded-md bg-stone-800 hover:bg-stone-700 text-white text-[13px] transition-all cursor-pointer" style="flex-shrink: 0;">Portfolio v14</span>
			...
			<div id="app-options" class="absolute w-full h-[100vh] top-0 left-0 bg-white/10 backdrop-blur-xl z-[9999] flex items-center justify-center">
				...
				<div class="w-[40vh] p-2 ml-5 bg-stone-900/[90%] backdrop-blur-xl rounded-lg border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="fenetreBienvenue2" class="absolute right-6 top-6 w-[45vh] bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 shadow shadow-stone-900/75 rounded-lg p-4 z-[1001]">
			...
			<div class="absolute top-6 left-6 z-[1] flex items-start">
				...
				<div class="p-4 bg-stone-900/25 backdrop-blur-md rounded-md border border-white/[15%] shadow shadow-stone-900/10">
					...
					<div class="w-full grid grid-cols-3 gap-4">
						...
						<div class="w-[6.5vh] h-[6.5vh] flex items-center justify-center bg-stone-900 rounded-lg border border-white/10 hover:scale-[110%] hover:bg-stone-900/95 hover:border-white/25 transition-all cursor-pointer shadow shadow-stone-900/75" onclick="ouvrir_app_images()" title="Ouvrir l'application Images à coller" name="Ouvrir l'application Images à coller">
				...
				<div class="w-[30vh] ml-6 p-4 bg-stone-900/25 backdrop-blur-md rounded-md border border-white/[15%] shadow shadow-stone-900/10">
					...
					<div class="w-full text-white text-[12px] pb-2 mb-4 border-b border-white/[15%]">
						...
						Applications - Mes Projets

					</div>
					
					<div class="w-full h-[22.5vh] overflow-y-scroll pr-4 grid grid-cols-1 gap-4">
				
						<div class="w-full h-[6.5vh] flex items-center justify-center bg-stone-900 rounded-lg border border-white/10 hover:scale-[95%] hover:bg-stone-900/95 hover:border-white/25 transition-all cursor-pointer shadow shadow-stone-900/75" title="Ouvrir hugodoueil-ressource.netlify.app" name="Ouvrir hugodoueil-ressource.netlify.app">

							<svg xmlns="http://www.w3.org/2000/svg" class="w-[14px] h-[14px] text-white" fill="none" stroke="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
							  	<path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
							</svg>

							<p class="text-white ml-3 text-[12px]">hugodoueil-ressource.netlify.app</p>

						</div>

						<div class="w-full h-[6.5vh] flex items-center justify-center bg-stone-900 rounded-lg border border-white/10 hover:scale-[95%] hover:bg-stone-900/95 hover:border-white/25 transition-all cursor-pointer shadow shadow-stone-900/75" title="Ouvrir hugodoueil-portfolio.netlify.app" name="Ouvrir hugodoueil-portfolio.netlify.app">

							<svg xmlns="http://www.w3.org/2000/svg" class="w-[14px] h-[14px] text-white" fill="none" stroke="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
							  	<path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
							</svg>

							<p class="text-white ml-3 text-[12px]">hugodoueil-portfolio.netlify.app</p>

						</div>

						<div class="w-full h-[6.5vh] flex items-center justify-center bg-stone-900 rounded-lg border border-white/10 hover:scale-[95%] hover:bg-stone-900/95 hover:border-white/25 transition-all cursor-pointer shadow shadow-stone-900/75" title="Ouvrir hugodoueil-station.netlify.app" name="Ouvrir hugodoueil-station.netlify.app">

							<svg xmlns="http://www.w3.org/2000/svg" class="w-[14px] h-[14px] text-white" fill="none" stroke="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
							  	<path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
							</svg>

							<p class="text-white ml-3 text-[12px]">hugodoueil-station.netlify.app</p>

						</div>

						<div class="w-full h-[6.5vh] flex items-center justify-center bg-stone-900 rounded-lg border border-white/10 hover:scale-[95%] hover:bg-stone-900/95 hover:border-white/25 transition-all cursor-pointer shadow shadow-stone-900/75" title="Ouvrir hugodoueil-station.netlify.app" name="Ouvrir hugodoueil-station.netlify.app">

							<svg xmlns="http://www.w3.org/2000/svg" class="w-[3.5vh] h-[3.5vh] text-white" fill="none" stroke="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
							  	<path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
							</svg>
			...
			<div class="absolute bottom-0 left-0 w-full pb-6 flex items-center justify-center z-[999] animate__animated animate__fadeInUp">
				...
				<div class="px-3 py-2 rounded-lg bg-stone-900/[95%] backdrop-blur-xl border border-stone-700 flex items-center shadow shadow-stone-900/75">
			...
			<!-- APPLICATION MENU -->
			<div id="app-menu" class="absolute bottom-6 left-6 w-[40vh] p-2 bg-stone-900/[90%] backdrop-blur-xl rounded-lg border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<!-- APPLICATION PROJETS -->
			<div id="app-projets" class="absolute top-6 left-6 w-[77vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div id="app-projets-body" class="w-full h-[55vh] overflow-y-scroll mt-5 bg-stone-800 rounded-lg p-3">
					...
					<div class="w-full">
						...
						<div class="w-full flex items-center mt-2">
							...
							<span class="text-[11px] text-blue-500 bg-blue-500/10 px-2 py-1 rounded-lg border border-blue-500/25 mr-2">Projet Scolaire / Personnel</span>

							<span class="text-[11px] text-orange-500 bg-orange-500/10 px-2 py-1 rounded-lg border border-orange-500/25 mr-2">Projet Scolaire</span>

							<span class="text-[11px] text-green-500 bg-green-500/10 px-2 py-1 rounded-lg border border-green-500/25">Projet Personnel</span>
					...
					<div id="app-projets-body-grid" class="w-full grid grid-cols-2 gap-5">
						...
						<!-- CARD D'UN PROJET -->
						<div class="w-[35vh] rounded-lg bg-stone-900 border border-stone-700 overflow-hidden cursor-pointer group">
						
							<div class="w-full h-[15vh] bg-[url('ressources/images/portfolio.png')] bg-cover bg-center p-3">
								
								<a href="https://hugodoueil-portfolio.netlify.app" onclick="window.open(this.href); return false;"><p class="text-[11px] text-[11px] text-white bg-stone-800/50 hover:bg-stone-800/75 border border-stone-700/75 hover:border-stone-900/75 px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-all flex items-center shadow shadow-black/10 backdrop-blur-xl">
								...
								<a href="#" onclick="window.open(this.href); return false;"><p class="mt-2 text-[11px] text-[11px] text-white bg-stone-800/50 hover:bg-stone-800/75 border border-stone-700/75 hover:border-stone-900/75 px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-all flex items-center shadow shadow-black/10 backdrop-blur-xl">
							...
							<div class="w-full p-3">
								...
								<div class="mt-5 w-full flex items-end justify-start">
									...
									<span class="text-[11px] text-blue-500 bg-blue-500/10 px-2 py-1 rounded-lg border border-blue-500/25">2022 - Projet Scolaire / Personnel</span>
						...
						<div class="w-[35vh] rounded-lg bg-stone-900 border border-stone-700 overflow-hidden cursor-pointer group">
							...
							<div class="w-full h-[15vh] bg-[url('ressources/images/ppe1.png')] bg-cover bg-center p-3">
								...
								<a href="https://github.com/Ormidales/btssio32-ppe1" onclick="window.open(this.href); return false;"><p class="text-[11px] text-[11px] text-white bg-stone-800/50 hover:bg-stone-800/75 border border-stone-700/75 hover:border-stone-900/75 px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-all flex items-center shadow shadow-black/10 backdrop-blur-xl">
							...
							<div class="w-full p-3">
								...
								<div class="mt-5 w-full flex items-end justify-start">
									...
									<span class="text-[11px] text-orange-500 bg-orange-500/10 px-2 py-1 rounded-lg border border-orange-500/25">2020 / 2021 - Projet Scolaire</span>
						...
						<div class="w-[35vh] rounded-lg bg-stone-900 border border-stone-700 overflow-hidden cursor-pointer group">
							...
							<div class="w-full h-[15vh] bg-[url('ressources/images/ppe2.png')] bg-cover bg-center p-3">
								...
								<a href="https://hugodoueil-ressource.netlify.app/projets-scolaires/ppe2/ppe2v8" onclick="window.open(this.href); return false;"><p class="text-[11px] text-white bg-stone-800/50 hover:bg-stone-800/75 border border-stone-700/75 hover:border-stone-900/75 px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-all flex items-center shadow shadow-black/10 backdrop-blur-xl">
							...
							<div class="w-full p-3">
								...
								<div class="mt-5 w-full flex items-end justify-start">
									...
									<span class="text-[11px] text-orange-500 bg-orange-500/10 px-2 py-1 rounded-lg border border-orange-500/25">2021 - Projet Scolaire</span>
						...
						<div class="w-[35vh] rounded-lg bg-stone-900 border border-stone-700 overflow-hidden cursor-pointer group">
							...
							<div class="w-full h-[15vh] bg-[url('ressources/images/ppe3.png')] bg-cover bg-center p-3">
								...
								<a href="https://hugodoueil-ressource.netlify.app/projets-scolaires/ppe3/ppe3v1/" onclick="window.open(this.href); return false;"><p class="text-[11px] text-white bg-stone-800/50 hover:bg-stone-800/75 border border-stone-700/75 hover:border-stone-900/75 px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-all flex items-center shadow shadow-black/10 backdrop-blur-xl">
			...
			<div id="app-background" class="absolute top-6 left-6 w-[35vh] p-2 bg-stone-900/[90%] backdrop-blur-xl rounded-lg border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div class="w-full h-[40vh] overflow-y-scroll pr-2 mt-2">
					...
					<div class="w-full">
						...
						<div class="w-full p-3">
							...
							<div class="w-full rounded-lg h-[10vh] bg-[url('ressources/images/bg-1.jpg')] bg-cover bg-center border border-stone-700 hover:border-white transition-all flex items-center justify-center cursor-pointer" onclick="background_image1()">
								
								<span class="px-3 py-2 bg-white/10 rounded-lg backdrop-blur-xl border border-white/25 text-white text-[10px]">Forêt</span>

							</div>

							<div class="mt-3 w-full rounded-lg h-[10vh] bg-[url('ressources/images/bg-2.jpg')] bg-cover bg-center border border-stone-700 hover:border-white transition-all flex items-center justify-center cursor-pointer" onclick="background_image2()">
								
								<span class="px-3 py-2 bg-white/10 rounded-lg backdrop-blur-xl border border-white/25 text-white text-[10px]">Aurore</span>

							</div>

							<div class="mt-3 w-full rounded-lg h-[10vh] bg-[url('ressources/images/bg-3.jpg')] bg-cover bg-center border border-stone-700 hover:border-white transition-all flex items-center justify-center cursor-pointer" onclick="background_image3()">
							...
							<div class="mt-3 w-full rounded-lg h-[10vh] bg-[url('ressources/images/bg-4.jpg')] bg-cover bg-center border border-stone-700 hover:border-white transition-all flex items-center justify-center cursor-pointer" onclick="background_image4()">
								
								<span class="px-3 py-2 bg-white/10 rounded-lg backdrop-blur-xl border border-white/25 text-white text-[10px]">Champs</span>

							</div>

							<div class="mt-3 w-full rounded-lg h-[10vh] bg-[url('ressources/images/bg-5.jpg')] bg-cover bg-center border border-stone-700 hover:border-white transition-all flex items-center justify-center cursor-pointer" onclick="background_image5()">
								
								<span class="px-3 py-2 bg-white/10 rounded-lg backdrop-blur-xl border border-white/25 text-white text-[10px]">Neige</span>

							</div>

							<div class="mt-3 w-full rounded-lg h-[10vh] bg-[url('ressources/images/bg-6.jpg')] bg-cover bg-center border border-stone-700 hover:border-white transition-all flex items-center justify-center cursor-pointer" onclick="background_image6()">
								
								<span class="px-3 py-2 bg-white/10 rounded-lg backdrop-blur-xl border border-white/25 text-white text-[10px]">Ville</span>
			...
			<div id="app-welcome" class="absolute bottom-6 left-6 w-[40vh] p-3 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div class="w-full mt-3 flex items-center">
					...
					<a href="https://twitter.com/ormidales2" onclick="window.open(this.href); return false;" class="p-2 text-[12px] text-white rounded-md bg-white/5 hover:bg-white/10 transition-all">
						
						<svg role="img" class="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><title>Twitter</title><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>

					</a>

					<a href="https://github.com/Ormidales" onclick="window.open(this.href); return false;" class="p-2 text-[12px] text-white rounded-md bg-white/5 hover:bg-white/10 transition-all ml-2">
					...
					<a href="https://www.instagram.com/hugo.doueil1/" onclick="window.open(this.href); return false;" class="p-2 text-[12px] text-white rounded-md bg-white/5 hover:bg-white/10 transition-all ml-2">
						
						<svg role="img" class="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><title>Instagram</title><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678c-3.405 0-6.162 2.76-6.162 6.162 0 3.405 2.76 6.162 6.162 6.162 3.405 0 6.162-2.76 6.162-6.162 0-3.405-2.76-6.162-6.162-6.162zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405c0 .795-.646 1.44-1.44 1.44-.795 0-1.44-.646-1.44-1.44 0-.794.646-1.439 1.44-1.439.793-.001 1.44.645 1.44 1.439z"/></svg>
				...
				<div class="w-full h-[25vh] mt-5 overflow-y-scroll bg-stone-800 rounded-lg p-3">
					...
					<div class="mt-3 w-full p-2 rounded-lg bg-stone-900 border border-stone-700 hover:bg-stone-900/75 transition-all">
						...
						<span class="px-2 py-1 border border-blue-500/25 rounded-md bg-blue-500/10 text-blue-500 text-[10px]">Actuel</span>
			...
			<!-- APPLICATION STAGES -->
			<div id="app-stages" class="absolute top-6 right-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-magasin" class="absolute bottom-6 right-6 w-[60vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div class="w-full h-[45vh] mt-5 overflow-y-scroll bg-stone-800 rounded-lg p-3">
					...
					<div class="mt-8 w-full p-5 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden">
						...
						<div class="w-full mt-5 md:flex md:items-center gap-x-3 block">
							...
							<span class="w-full px-3 py-2 bg-blue-500 hover:bg-blue-400 transition-all text-[10px] text-white flex items-center justify-center rounded-md cursor-pointer" onclick="ouvrir_app_images()">Lancer l'application</span>
			...
			<!-- APPLICATION CV -->
			<div id="app-cv" class="absolute top-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-certifications" class="absolute top-6 right-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-veilletechno" class="absolute bottom-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<!-- APPLICATION IMAGES -->
			<div id="app-images" class="absolute bottom-6 right-6 w-[25vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div id="app-images-header" class="w-full pb-2 px-2 flex items-center justify-between border-b border-stone-700">
					...
					<div class="flex items-center">
						...
						<p class="text-[12px] text-white ml-2">Images à coller</p>
				...
				<div class="w-full h-[55vh] mt-5 bg-stone-800 rounded-lg p-3 overflow-y-scroll">
					...
					<div class="w-full py-2 flex items-center justify-center bg-stone-900 border border-stone-700 rounded-lg hover:bg-stone-800 hover:border-stone-600 transition-all text-[12px] text-white cursor-pointer" onclick="imagesColler_supprimer()">Tout supprimer</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_chapeauNoel()">
						
						<img src="ressources/images/png/chapeau-noel.png" class="h-[6vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_teteGabe()">
						
						<img src="ressources/images/png/tete-gabe.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_teteGigachad()">
						
						<img src="ressources/images/png/tete-gigachad.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_lunetteMlg()">
						
						<img src="ressources/images/png/lunette-mlg.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsMacron()">
						
						<img src="ressources/images/png/corps-macron.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsZemmour()">
						
						<img src="ressources/images/png/corps-zemmour.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsGigachad()">
						
						<img src="ressources/images/png/corps-gigachad.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsTiboinshape()">
						
						<img src="ressources/images/png/corps-tiboinshape.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsFanta()">
						
						<img src="ressources/images/png/corps-fantasio.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsBoblennon()">
						
						<img src="ressources/images/png/corps-boblennon.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsSteve()">
						
						<img src="ressources/images/png/corps-steve.png" class="h-[8vh] group-hover:scale-[110%] transition-all">

					</div>

					<div class="mt-3 w-full h-[10vh] bg-stone-900 border border-stone-700 rounded-lg flex items-center justify-center group hover:bg-stone-800 hover:border-stone-600 transition-all cursor-pointer" onclick="imagesColler_corpsBiden()">
						
						<img src="ressources/images/png/corps-biden.png" class="h-[8vh] group-hover:scale-[110%] transition-all">
			...
			<!-- IMAGES A COLLER -->
			<img id="imagesColler_chapeauNoel" src="ressources/images/png/chapeau-noel.png" class="absolute top-6 right-6 w-[10vh] z-[10]">

			<img id="imagesColler_teteGabe" src="ressources/images/png/tete-gabe.png" class="absolute top-6 right-6 w-[12vh] z-[8]">

			<img id="imagesColler_teteGigachad" src="ressources/images/png/tete-gigachad.png" class="absolute top-6 right-6 w-[12vh] z-[8]">

			<img id="imagesColler_lunetteMlg" src="ressources/images/png/lunette-mlg.png" class="absolute top-6 right-6 w-[12vh] z-[12]">

			<img id="imagesColler_corpsMacron" src="ressources/images/png/corps-macron.png" class="absolute top-6 right-6 w-[30vh] z-[7]">

			<img id="imagesColler_corpsZemmour" src="ressources/images/png/corps-zemmour.png" class="absolute top-6 right-6 w-[30vh] z-[6]">

			<img id="imagesColler_corpsGigachad" src="ressources/images/png/corps-gigachad.png" class="absolute top-6 right-6 w-[40vh] z-[6]">

			<img id="imagesColler_corpsTiboinshape" src="ressources/images/png/corps-tiboinshape.png" class="absolute top-6 right-6 w-[25vh] z-[6]">

			<img id="imagesColler_corpsFanta" src="ressources/images/png/corps-fantasio.png" class="absolute top-6 right-6 w-[25vh] z-[6]">

			<img id="imagesColler_corpsBoblennon" src="ressources/images/png/corps-boblennon.png" class="absolute top-6 right-6 w-[35vh] z-[6]">

			<img id="imagesColler_corpsSteve" src="ressources/images/png/corps-steve.png" class="absolute top-6 right-6 w-[25vh] z-[6]">

			<img id="imagesColler_corpsBiden" src="ressources/images/png/corps-biden.png" class="absolute top-6 right-6 w-[80vh] z-[6]">



			<!-- APPLICATION MENTIONS LEGALES -->
			<div id="app-mentionslegales" class="absolute top-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-parametreconfidentialite" class="absolute top-6 right-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-plandusite" class="absolute bottom-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
				...
				<div class="w-full h-[45vh] mt-5 overflow-y-scroll bg-stone-800 rounded-lg p-3">
					...
					<div class="w-full p-2 rounded-lg bg-stone-900 border border-stone-700 hover:bg-stone-900/75 transition-all">
						...
						<span class="px-3 py-2 mb-3 bg-blue-500 hover:bg-blue-400 transition-all text-[10px] text-white flex items-center justify-center rounded-md cursor-pointer" onclick="ouvrir_app_images()">Application Images à coller</span>
		...
		<div id="bureau-md" class="md:hidden block w-full">
            ...
            <!-- BACKGROUND -->
			<section class="relative w-full bg-[url('ressources/images/background-5.webp')] bg-cover bg-fixed flex justify-center">
				
				<div class="relative mt-40 mb-40 w-[100vh] p-8 bg-white/10 backdrop-blur-md border border-white/25 rounded-2xl shadow-xl">
					
					<a href="index.html"><img src="ressources/images/KEEPSMILING.webp" style="animation: 3s infinite alternate image-boing;" class="relative w-56 h-56" alt="KEEPSMILING.webp" title="Logo"></a>

					<a href="index.html"><h1 class="mt-10 text-[100px] text-white font-bold" style="font-family: Casanova, sans-serif; letter-spacing: 1vh;">HUGO DOUEIL</h1></a>

					<p class="mt-0 text-[20px] text-white font-bold" style="font-family: Maghfirea, sans-serif; letter-spacing: 1vh;">Étudiant BTS SIO SLAM Auch (32000)</p>

					<div class="mt-20 w-full h-0 border-t border-slate-100"></div>

					<div class="mt-10 w-full flex items-center flex-wrap">
						
						<a href="https://hugodoueil-hugoos.netlify.app"><div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg xmlns="http://www.w3.org/2000/svg" class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					...
					<p class="mt-20 text-[35px] text-white font-bold" style="font-family: Casanova, sans-serif; letter-spacing: 1vh;">QUI SUIS-JE ?</p>

					<p class="mt-10 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">Bonjour, je m'appelle Hugo Doueil, je suis un étudiant de BTS SIO SLAM au lycée Pardailhan à Auch (32000). Intéressé par l'informatique et la conception de site web, J'aimerai me spécialiser dans ce domaine et en faire mon métier. Pour cela, j'ai pris connaissance de plusieurs langages informatiques tels que les langages de Balisages (HTML, CSS), de Programmations (C#, Javascript, PHP, etc...), je pratique le développement chez moi car j'aime créer mes propres sites webs.</p>

					<div class="mt-10 w-full flex items-center flex-wrap">
						
						<a href="html/cv.html"><div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 8V2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10h-6a2 2 0 0 1-2-2Zm-3.75 3.5h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5Zm0 2.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5Zm0 2.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5Zm5.25-9V2.5l6 6H14a.5.5 0 0 1-.5-.5Z" fill="#ffffff"/></svg>
							Voir mon CV
						</div></a>

						<a href="html/certifications.html"><div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15 18c.835.629 1.875 1.001 3 1.001a4.978 4.978 0 0 0 3-.999v3.246a.75.75 0 0 1-1.09.67l-.09-.055L18 20.591l-1.82 1.272a.75.75 0 0 1-1.172-.51l-.007-.105L15 18.001Zm4.25-14.996a2.75 2.75 0 0 1 2.745 2.582l.005.168.001 5.246a5.027 5.027 0 0 0-1.5-1.331L20.5 5.754a1.25 1.25 0 0 0-1.122-1.244l-.128-.006H4.75a1.25 1.25 0 0 0-1.244 1.122l-.006.128v9.5c0 .647.492 1.18 1.122 1.243l.128.007h8.92c.1.172.21.338.33.496v1.004H4.75a2.75 2.75 0 0 1-2.745-2.583L2 15.254v-9.5a2.75 2.75 0 0 1 2.582-2.745l.168-.005h14.5ZM18 10A4 4 0 1 1 18 18 4 4 0 0 1 18 10Zm-6.75 2.5a.75.75 0 0 1 .102 1.493L11.25 14h-4.5a.75.75 0 0 1-.102-1.493l.102-.007h4.5Zm6-5.5a.75.75 0 0 1 .102 1.493l-.102.007H6.75a.75.75 0 0 1-.102-1.493L6.75 7h10.5Z" fill="#ffffff"/></svg>
					...
					<div class="mt-10 w-full flex items-center flex-wrap">
						...
						<a href="html/veilletechno.html"><div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16.75 4a2.25 2.25 0 0 1 2.245 2.096L19 6.25V17.5a.5.5 0 0 0 .992.09L20 17.5V7.014a2.25 2.25 0 0 1 1.994 2.072L22 9.25v7.5a3.25 3.25 0 0 1-3.066 3.245L18.75 20H5.25a3.25 3.25 0 0 1-3.245-3.066L2 16.75V6.25a2.25 2.25 0 0 1 2.096-2.245L4.25 4h12.5Zm-7.502 7h-3.5a.75.75 0 0 0-.75.75v3.5c0 .414.336.75.75.75h3.5a.75.75 0 0 0 .75-.75v-3.5a.75.75 0 0 0-.75-.75Zm6.004 3.5h-2.498l-.102.007A.75.75 0 0 0 12.754 16h2.498l.102-.007a.75.75 0 0 0-.102-1.493Zm-6.754-2v2h-2v-2h2ZM15.25 11l-2.498.005-.102.006a.75.75 0 0 0 .104 1.494l2.499-.005.101-.007A.75.75 0 0 0 15.251 11Zm.001-3.496H5.748l-.102.007a.75.75 0 0 0 .102 1.493h9.504l.102-.006a.75.75 0 0 0-.102-1.494Z" fill="#ffffff"/></svg>
							Voir ma veille technologique
						</div></a>

						<a href="html/stages.html"><div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15.25 3a.75.75 0 0 1 .75.75V7h1.75A3.25 3.25 0 0 1 21 10.25v6.5A3.25 3.25 0 0 1 17.75 20H6.25A3.25 3.25 0 0 1 3 16.75v-6.5A3.25 3.25 0 0 1 6.25 7H8V3.75a.75.75 0 0 1 .648-.743L8.75 3h6.5Zm-.75 1.5h-5V7h5V4.5Z" fill="#ffffff"/></svg>
							Voir mes stages
						</div></a>
					...
					<p class="mt-20 text-[35px] text-white font-bold" style="font-family: Casanova, sans-serif; letter-spacing: 1vh;">C'EST QUOI LE BTS SIO SLAM ?</p>

					<p class="mt-10 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">Ce BTS prépare aux métiers de l’informatique Tertiaire : développement et administration d’applications et de systèmes qui sont utilisés pour les fonctions tertiaires, dans les organisations. Il s’agit donc d’applications et de systèmes de gestion des fichiers clients, des fichiers fournisseurs, d’administration des relations avec les clients et les fournisseurs (commandes – livraisons – facturations), de gestion des personnels, de relations avec tous les partenaires de l’entreprise… Il prépare aussi à la conception et à l’administration de réseaux. L’informatique tertiaire est donc différente de l’informatique industrielle.</p>

					<div class="mt-20 w-full h-0 border-t border-slate-100"></div>

					<p class="mt-20 text-[35px] text-white font-bold" style="font-family: Casanova, sans-serif; letter-spacing: 1vh;">MON PARCOURS SCOLAIRE :</p>

					<p class="mt-10 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">- Brevet des Collèges en 2015 au Collège Didier Daurat à SAINT-GAUDENS 31800.</p>

					<p class="mt-8 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">- Sciences et Technologies de l’industrie et du Développement Durable option Énergie et Environnement au Lycée Paul Mathou à GOURDAN POLIGNAN 31800, Mention Assez Bien. Projet en Terminal STI2D EE : Abri à vélo électrique avec panneaux solaires intégrés et rotatif suivant la position du soleil dans le ciel.</p>

					<p class="mt-8 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">- BTS SIO (Services Informatiques aux Organisations) SLAM (Solutions Logicielles et Applications Métier) au Lycée Pardailhan de AUCH 32000. <a href="html/certifications.html" class="underline">Certifié Atelier RGPD (CNIL MOOC) et SecNum Académie (ANSSI).</a></p>

					<div class="mt-20 w-full h-0 border-t border-slate-100"></div>

					<p class="mt-20 text-[35px] text-white font-bold" style="font-family: Casanova, sans-serif; letter-spacing: 1vh;">MES PROJETS :</p>

					<div class="mt-10 w-full bg-[url('ressources/images/background-3.webp')] bg-cover bg-fixed rounded-tl-2xl rounded-br-2xl border border-white shadow-xl">

						<div class="w-full p-8 rounded-tl-2xl rounded-br-2xl backdrop-blur-lg">
							
							<div class="w-full h-96 bg-[url('ressources/images/portfolio.png')] bg-cover rounded-tl-2xl rounded-br-2xl border border-white" style="transform: translateZ(20px);"></div>

							<p class="mt-8 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh; transform: translateZ(20px);">Portfolio 2021 - 2022 / Hugo Doueil</p>

							<div class="mt-8 flex items-center">
								
								<div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh; transform: translateZ(20px);">
									<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M11 5h5.745a2.25 2.25 0 0 1 2.25 2.25V11h-1.5V7.25a.75.75 0 0 0-.75-.75H11V5Zm-4.5 6v5.745c0 .414.336.75.75.75H11v1.5H7.25A2.25 2.25 0 0 1 5 16.745V11h1.5ZM2 4.25A2.25 2.25 0 0 1 4.25 2h3.5A2.25 2.25 0 0 1 10 4.25v3.5A2.25 2.25 0 0 1 7.75 10h-3.5A2.25 2.25 0 0 1 2 7.75v-3.5ZM12 14.25A2.25 2.25 0 0 1 14.25 12h5.5A2.25 2.25 0 0 1 22 14.25v5.5A2.25 2.25 0 0 1 19.75 22h-5.5A2.25 2.25 0 0 1 12 19.75v-5.5Z" fill="#ffffff"/></svg>
									Voir le projet
								</div>
					...
					<div class="mt-10 w-full bg-[url('ressources/images/background-3.webp')] bg-cover bg-fixed rounded-tl-2xl rounded-br-2xl border border-white shadow-xl">
						...
						<div class="w-full p-8 rounded-tl-2xl rounded-br-2xl backdrop-blur-lg">
							...
							<div class="w-full h-96 bg-[url('ressources/images/ppe1.png')] bg-cover rounded-tl-2xl rounded-br-2xl border border-white" style="transform: translateZ(20px);"></div>

							<p class="mt-8 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh; transform: translateZ(20px);">PPE1 - BTS SIO SLAM</p>
					...
					<div class="mt-10 w-full bg-[url('ressources/images/background-3.webp')] bg-cover bg-fixed rounded-tl-2xl rounded-br-2xl border border-white shadow-xl">
						...
						<div class="w-full p-8 rounded-tl-2xl rounded-br-2xl backdrop-blur-lg">
							...
							<div class="w-full h-96 bg-[url('ressources/images/ppe2.png')] bg-cover rounded-tl-2xl rounded-br-2xl border border-white" style="transform: translateZ(20px);"></div>

							<p class="mt-8 text-[20px] text-white" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh; transform: translateZ(20px);">PPE2 - BTS SIO SLAM</p>
					...
					<div class="w-full mt-20 flex items-center">
						...
						<a href="html/projets.html"><div class="py-4 px-10 border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M13.821 6.5h5.929a2.25 2.25 0 0 1 2.229 1.938l.016.158.005.154v9a2.25 2.25 0 0 1-2.096 2.245L19.75 20H4.25a2.25 2.25 0 0 1-2.245-2.096L2 17.75v-7.251l6.207.001.196-.009a2.25 2.25 0 0 0 1.088-.393l.156-.12L13.821 6.5ZM8.207 4c.46 0 .908.141 1.284.402l.156.12 2.103 1.751-3.063 2.553-.085.061a.75.75 0 0 1-.29.106L8.206 9 2 8.999V6.25a2.25 2.25 0 0 1 2.096-2.245L4.25 4h3.957Z" fill="#ffffff"/></svg>
					...
					<p class="mt-20 text-[35px] text-white font-bold" style="font-family: Casanova, sans-serif; letter-spacing: 1vh;">OU ME TROUVER ?</p>

					<div class="mt-10 w-full flex items-center flex-wrap">
						
						<div class="py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg role="img" class="w-10 h-10 mr-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Twitter</title><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" style="fill: white;"/></svg>
							Twitter
						</div>

						<div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg role="img" class="w-10 h-10 mr-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>LinkedIn</title><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" style="fill: white;"/></svg>
							Linkedin
						</div>

						<div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg role="img" class="w-10 h-10 mr-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" style="fill: white;"/></svg>
							Github
						</div>
					...
					<p class="mt-20 text-[35px] text-white font-bold" style="font-family: Casanova, sans-serif; letter-spacing: 1vh;">INFORMATIONS IMPORTANTES :</p>

					<div class="mt-10 w-full flex items-center flex-wrap">
						
						<a href="html/mentionslegales.html"><div class="py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H18a2.5 2.5 0 0 1 2.5 2.5v14.25a.75.75 0 0 1-.75.75H5.5a1 1 0 0 0 1 1h13.25a.75.75 0 0 1 0 1.5H6.5A2.5 2.5 0 0 1 4 19.5v-15ZM12.25 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm-.75 1.75v5a.75.75 0 0 0 1.5 0v-5a.75.75 0 0 0-1.5 0Z" fill="#ffffff"/></svg>
							Mentions légales
						</div></a>

						<a href="html/plandusite.html"><div class="lg:ml-8 lg:mt-0 ml-0 mt-8 py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M8.5 4.358v12.465l-4.32 3.038a.75.75 0 0 1-1.174-.509l-.007-.104V8.615a.75.75 0 0 1 .238-.548l.08-.065L8.5 4.358Zm12.494.29.007.104v10.633a.75.75 0 0 1-.238.548l-.08.065L15.5 19.64V7.174l4.32-3.035a.75.75 0 0 1 1.174.509ZM10 4.359l4 2.812v12.467l-4-2.814V4.359Z" fill="#ffffff"/></svg>
							Plan du site
						</div></a>
					...
					<div class="mt-10 w-full flex items-center flex-wrap">
						...
						<a href="html/chartedonnees.html"><div class="py-4 px-10 flex items-center border border-white rounded-tl-2xl rounded-br-2xl text-[20px] text-white hover:bg-white/25 flex items-center" style="font-family: Maghfirea, sans-serif; letter-spacing: 0.5vh;">
							<svg class="mr-4" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M10.557 8.423C10.068 8.686 10 8.925 10 9c0 .075.068.314.557.577.46.247 1.145.423 1.943.423s1.484-.176 1.943-.423C14.932 9.314 15 9.075 15 9c0-.075-.068-.314-.557-.577C13.982 8.176 13.298 8 12.5 8s-1.484.176-1.943.423ZM15 13v-2.024c-.695.337-1.573.524-2.5.524s-1.805-.187-2.5-.524V13c0 .075.068.313.557.577.46.247 1.145.423 1.943.423s1.484-.176 1.943-.423c.489-.264.557-.502.557-.577Z" fill="#ffffff"/><path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H18a2.5 2.5 0 0 1 2.5 2.5v14.25a.75.75 0 0 1-.75.75H5.5a1 1 0 0 0 1 1h13.25a.75.75 0 0 1 0 1.5H6.5A2.5 2.5 0 0 1 4 19.5v-15Zm5.846 2.602C9.16 7.472 8.5 8.11 8.5 9v4c0 .891.66 1.528 1.346 1.898.718.386 1.657.602 2.654.602.997 0 1.936-.216 2.654-.602.687-.37 1.346-1.007 1.346-1.898V9c0-.891-.66-1.528-1.346-1.898-.718-.386-1.657-.602-2.654-.602-.997 0-1.936.216-2.654.602Z" fill="#ffffff"/></svg>
							Chartes des données
						</div></a>

					</div>

					<p class="mt-20 text-[20px] text-white font-bold" style="font-family: Maghfirea, sans-serif; letter-spacing: 1vh;">Hugo Doueil | Portfolio 2022</p>
        ...
        <script>
            ...
            var dragAppImageColler7 = Draggable.create("#imagesColler_teteGigachad" , {
                bounds: document.getElementById("bureau-xl"),
                inertia: {top: {min: 0, max: 1000, end: [0,200,400,600]}},
                dragClickables: true,
                trigger: "#imagesColler_teteGigachad",
                zIndexBoost: false,
                edgeResistance:0.5,
            });
            ...
            var dragAppImageColler6 = Draggable.create("#imagesColler_corpsGigachad" , {
                bounds: document.getElementById("bureau-xl"),
                inertia: {top: {min: 0, max: 1000, end: [0,200,400,600]}},
                dragClickables: true,
                trigger: "#imagesColler_corpsGigachad",
                zIndexBoost: false,
                edgeResistance:0.5,
            });

            var dragAppImageColler8 = Draggable.create("#imagesColler_corpsTiboinshape" , {
                bounds: document.getElementById("bureau-xl"),
                inertia: {top: {min: 0, max: 1000, end: [0,200,400,600]}},
                dragClickables: true,
                trigger: "#imagesColler_corpsTiboinshape",
                zIndexBoost: false,
                edgeResistance:0.5,
            });

            var dragAppImageColler9 = Draggable.create("#imagesColler_corpsFanta" , {
                bounds: document.getElementById("bureau-xl"),
                inertia: {top: {min: 0, max: 1000, end: [0,200,400,600]}},
                dragClickables: true,
                trigger: "#imagesColler_corpsFanta",
                zIndexBoost: false,
                edgeResistance:0.5,
            });

            var dragAppImageColler10 = Draggable.create("#imagesColler_corpsBoblennon" , {
                bounds: document.getElementById("bureau-xl"),
                inertia: {top: {min: 0, max: 1000, end: [0,200,400,600]}},
                dragClickables: true,
                trigger: "#imagesColler_corpsBoblennon",
                zIndexBoost: false,
                edgeResistance:0.5,
            });

            var dragAppImageColler11 = Draggable.create("#imagesColler_corpsSteve" , {
                bounds: document.getElementById("bureau-xl"),
                inertia: {top: {min: 0, max: 1000, end: [0,200,400,600]}},
                dragClickables: true,
                trigger: "#imagesColler_corpsSteve",
                zIndexBoost: false,
                edgeResistance:0.5,
            });

            var dragAppImageColler12 = Draggable.create("#imagesColler_corpsBiden" , {
                bounds: document.getElementById("bureau-xl"),
                inertia: {top: {min: 0, max: 1000, end: [0,200,400,600]}},
                dragClickables: true,
                trigger: "#imagesColler_corpsBiden",
                zIndexBoost: false,
                edgeResistance:0.5,
            });
