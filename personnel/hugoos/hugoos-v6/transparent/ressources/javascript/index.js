...
function ouvrir_contextMenu_sub2_projets(){
    ...
    document.getElementById("contextMenu_sub1").className = "w-[25vh] h-[40.9vh] rounded-l-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 shadow shadow-stone-900/75 overflow-y-auto";
}
function fermer_contextMenu_sub2_projets(){
    ...
    document.getElementById("contextMenu_sub1").className = "w-[25vh] h-[40.9vh] rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 overflow-hidden";
}
...
function zoomIn_app_projets(){
    document.getElementById("app-projets").className = "absolute top-6 left-6 w-[115vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function zoomOut_app_projets(){
    document.getElementById("app-projets").className = "absolute top-6 left-6 w-[77vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function zoomIn_app_stages(){
    document.getElementById("app-stages").className = "absolute top-6 left-6 w-[100vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function zoomOut_app_stages(){
    document.getElementById("app-stages").className = "absolute top-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function zoomIn_app_cv(){
    document.getElementById("app-cv").className = "absolute top-6 left-6 w-[95vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function zoomOut_app_cv(){
    document.getElementById("app-cv").className = "absolute top-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function zoomIn_app_certifications(){
    document.getElementById("app-certifications").className = "absolute top-6 left-6 w-[95vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function zoomOut_app_certifications(){
    document.getElementById("app-certifications").className = "absolute top-6 left-6 w-[75vh] p-2 rounded-lg bg-stone-900/[90%] backdrop-blur-xl border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]";
...
function imagesColler_supprimer(){
    ...
    document.getElementById("imagesColler_teteGigachad").style.visibility = "hidden";
    document.getElementById("imagesColler_teteGigachad").style.opacity = "0";
    document.getElementById("imagesColler_teteGigachad").style.transition = "opacity 200ms, visibility 0ms 200ms";
    ...
    document.getElementById("imagesColler_corpsGigachad").style.visibility = "hidden";
    document.getElementById("imagesColler_corpsGigachad").style.opacity = "0";
    document.getElementById("imagesColler_corpsGigachad").style.transition = "opacity 200ms, visibility 0ms 200ms";

    document.getElementById("imagesColler_corpsTiboinshape").style.visibility = "hidden";
    document.getElementById("imagesColler_corpsTiboinshape").style.opacity = "0";
    document.getElementById("imagesColler_corpsTiboinshape").style.transition = "opacity 200ms, visibility 0ms 200ms";

    document.getElementById("imagesColler_corpsFanta").style.visibility = "hidden";
    document.getElementById("imagesColler_corpsFanta").style.opacity = "0";
    document.getElementById("imagesColler_corpsFanta").style.transition = "opacity 200ms, visibility 0ms 200ms";

    document.getElementById("imagesColler_corpsBoblennon").style.visibility = "hidden";
    document.getElementById("imagesColler_corpsBoblennon").style.opacity = "0";
    document.getElementById("imagesColler_corpsBoblennon").style.transition = "opacity 200ms, visibility 0ms 200ms";

    document.getElementById("imagesColler_corpsSteve").style.visibility = "hidden";
    document.getElementById("imagesColler_corpsSteve").style.opacity = "0";
    document.getElementById("imagesColler_corpsSteve").style.transition = "opacity 200ms, visibility 0ms 200ms";

    document.getElementById("imagesColler_corpsBiden").style.visibility = "hidden";
    document.getElementById("imagesColler_corpsBiden").style.opacity = "0";
    document.getElementById("imagesColler_corpsBiden").style.transition = "opacity 200ms, visibility 0ms 200ms";
}
...
// IMAGE A COLLER (IMAGE 7)
function imagesColler_teteGigachad(){
    document.getElementById("imagesColler_teteGigachad").style.visibility = "visible";
    document.getElementById("imagesColler_teteGigachad").style.opacity = "1";
    document.getElementById("imagesColler_teteGigachad").style.transition = "opacity 200ms";
}
...
// IMAGE A COLLER (IMAGE 6)
function imagesColler_corpsGigachad(){
    document.getElementById("imagesColler_corpsGigachad").style.visibility = "visible";
    document.getElementById("imagesColler_corpsGigachad").style.opacity = "1";
    document.getElementById("imagesColler_corpsGigachad").style.transition = "opacity 200ms";
}
// IMAGE A COLLER (IMAGE 8)
function imagesColler_corpsTiboinshape(){
    document.getElementById("imagesColler_corpsTiboinshape").style.visibility = "visible";
    document.getElementById("imagesColler_corpsTiboinshape").style.opacity = "1";
    document.getElementById("imagesColler_corpsTiboinshape").style.transition = "opacity 200ms";
}
// IMAGE A COLLER (IMAGE 9)
function imagesColler_corpsFanta(){
    document.getElementById("imagesColler_corpsFanta").style.visibility = "visible";
    document.getElementById("imagesColler_corpsFanta").style.opacity = "1";
    document.getElementById("imagesColler_corpsFanta").style.transition = "opacity 200ms";
}
// IMAGE A COLLER (IMAGE 10)
function imagesColler_corpsBoblennon(){
    document.getElementById("imagesColler_corpsBoblennon").style.visibility = "visible";
    document.getElementById("imagesColler_corpsBoblennon").style.opacity = "1";
    document.getElementById("imagesColler_corpsBoblennon").style.transition = "opacity 200ms";
}
// IMAGE A COLLER (IMAGE 11)
function imagesColler_corpsSteve(){
    document.getElementById("imagesColler_corpsSteve").style.visibility = "visible";
    document.getElementById("imagesColler_corpsSteve").style.opacity = "1";
    document.getElementById("imagesColler_corpsSteve").style.transition = "opacity 200ms";
}
// IMAGE A COLLER (IMAGE 12)
function imagesColler_corpsBiden(){
    document.getElementById("imagesColler_corpsBiden").style.visibility = "visible";
    document.getElementById("imagesColler_corpsBiden").style.opacity = "1";
    document.getElementById("imagesColler_corpsBiden").style.transition = "opacity 200ms";
}
