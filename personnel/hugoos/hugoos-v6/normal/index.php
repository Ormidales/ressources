		...
		<section id="bureau-xl" class="md:flex hidden w-full h-[100vh] bg-[url('ressources/images/bg-1.jpg')] bg-cover bg-center items-center justify-center flex-wrap overflow-hidden">
			...
			<div id="contextMenu" class="context-menu z-[9999999] p-1">
				<div class="flex items-center">
					...
					<div id="contextMenu_sub1" class="w-[25vh] h-[40.9vh] rounded-lg bg-stone-900 border border-stone-700 shadow shadow-stone-900/75 overflow-y-auto">
			...
			<!-- APPLICATION STAGES -->
			<div id="app-stages" class="absolute top-6 right-6 w-[75vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-magasin" class="absolute bottom-6 right-6 w-[60vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-certifications" class="absolute top-6 right-6 w-[75vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<!-- APPLICATION IMAGES -->
			<div id="app-images" class="absolute bottom-6 right-6 w-[25vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
			...
			<div id="app-parametreconfidentialite" class="absolute top-6 right-6 w-[75vh] p-2 rounded-lg bg-stone-900 border border-stone-700 overflow-hidden shadow shadow-stone-900/75 z-[50] hover:z-[60]">
